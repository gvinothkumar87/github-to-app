        ...
        <SidebarMenu className="pt-4">
          ...
          <SidebarMenuItem>
            ...
            >
              ...
              <span className="text-lg font-medium">{language === 'english' ? 'Company Settings' : 'நிறுவன அமைப்புகள்'}</span>
            </SidebarMenuButton>
          </SidebarMenuItem>
          ...
          <SidebarMenuItem className="mt-auto">
            <SidebarMenuButton
              onClick={signOut}
              className="w-full justify-start px-4 py-3 h-auto transition-all duration-200 text-destructive hover:text-destructive hover:bg-destructive/10"
            >
              <LogOut className="mr-3 h-5 w-5" />
              <span className="text-lg font-medium">{language === 'english' ? 'Logout' : 'வெளியேறு'}</span>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
      </SidebarContent>
