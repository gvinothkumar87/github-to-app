  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const itemData = {
        ...
        kooli: parseFloat(formData.kooli),
      };
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <Label htmlFor="kooli">
                  {language === 'english' ? 'Kooli / Wage' : 'கூலி'}
                </Label>
                <Input
                  id="kooli"
                  type="number"
                  ...
                  onChange={(e) => setFormData({ ...formData, kooli: e.target.value })}
                  placeholder={language === 'english' ? 'Enter Kooli' : 'கூலியை உள்ளிடவும்'}
                />
              </div>
