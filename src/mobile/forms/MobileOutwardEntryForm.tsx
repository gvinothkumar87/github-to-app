...
const MobileOutwardEntryForm: React.FC = () => {
  ...
  // Use offline-ready data hook for locations
  const { data: locationsRaw } = useEnhancedOfflineData<CompanySetting>('offline_company_settings', [], { autoSync: true });
  ...
  }, [locations, formData.loading_place]);
