import { getEwayBillStyles, getEwayBillContentHtml } from './ewayBillTemplate';
  ...
  return `
        ...
        <head>
          ...
          <style>
            ...
            ${currentSale.eway_bill_no ? getEwayBillStyles() : ''}
          </style>
        </head>
        <body>
        ...
        return `
          ...
          ${currentSale.eway_bill_no ? getEwayBillContentHtml({
