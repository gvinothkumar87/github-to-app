-- Add mill column to purchases and stock_ledger tables
ALTER TABLE public.purchases ADD COLUMN IF NOT EXISTS mill TEXT NOT NULL DEFAULT 'MATTAPARAI';
ALTER TABLE public.stock_ledger ADD COLUMN IF NOT EXISTS mill TEXT NOT NULL DEFAULT 'MATTAPARAI';

-- Update the handle_purchase_stock function to consider mill
...
DECLARE
  ...
  v_mill TEXT := COALESCE(NEW.mill, 'MATTAPARAI');
BEGIN
